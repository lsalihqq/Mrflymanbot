...
Ü
    ...
    def __stats__():
        return "{} günlük kanalları seti.".format(sql.num_logchannels())
    ...
    def __chat_settings__(chat_id, user_id):
        ...
        if log_channel:
            ...
            return "Bu grup, gönderilen tüm günlükleri var: {} (`{}`)".format(escape_markdown(log_channel_info.title),
                                                                            log_channel)
        return "Bu grup için günlük kanalı ayarlı değil!"
...
- /setlog'u gruba iletme
"""

    __mod_name__ = "kayıt kanalı"
